...
| 4 — DAG adaptativo | `LOCAL_COMPOSABLE_AUTHORING_FOUNDATION` | reglas de `Mesh.Cutoff` y k-grid; productor real de observaciones; compositor de fragmentos con puertos científicos tipados; selección manual aislada/parcial/encadenada validada; ruta canónica preservada | aprobación/propagación, `converge_then_relax`, capacidades reales de relajación y consumo DOS/bandas/óptica, y aceptación remota |
