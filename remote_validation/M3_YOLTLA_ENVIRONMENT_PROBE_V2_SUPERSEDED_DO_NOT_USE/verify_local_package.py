...
if manifest.get('package_revision')!=2 or manifest.get('reproducibility_epoch')!='M3_STATIC_V2' or manifest.get('supersedes')!='M3_STATIC_V1':fail('PROBE_MANIFEST_REVISION_INVALID','expected V2')
