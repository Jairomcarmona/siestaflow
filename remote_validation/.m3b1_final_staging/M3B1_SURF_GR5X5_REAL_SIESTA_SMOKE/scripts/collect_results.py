...
required=[root/'package_manifest.json',root/'evidence/execution/summary.json',root/'evidence/accounting/sacct.txt',root/'results/siesta.out',root/'results/siesta.err']
...
with tarfile.open(out,'x:gz') as archive:
 for base in ('package_manifest.json','evidence','results'):
  path=root/base
